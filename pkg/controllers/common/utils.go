...
func getSharedNamespaceAndVpcForNamespace(client k8sclient.Client, ctx context.Context, namespaceName string) (string, error) {
...
func GetDefaultSubnetSet(client k8sclient.Client, ctx context.Context, namespace string, resourceType string) (*v1alpha1.SubnetSet, error) {
	targetNamespace, err := getSharedNamespaceAndVpcForNamespace(client, ctx, namespace)
	if err != nil {
		return nil, err
	}
	if targetNamespace == "" {
